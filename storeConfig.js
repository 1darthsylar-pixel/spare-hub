  ...
  stations: {
    ...
    BOH: {
      Mon: [
        ...
        { id: "truck", name: "Truck", section: "TRUCK / RECEIVING", hours: [{ start: 300, end: 510 }], duty: "PUT AWAY TRUCK ORDER / BOX COMPACTOR" },
        { id: "dish1", name: "Dish 1", section: "DISH / SANITATION", hours: [{ start: 1020, end: 1380 }], duty: "DISH SINK / DISH SHELVING / MOP SINK" },
